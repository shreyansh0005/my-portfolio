    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        <div className="footer--logo">
          <img src="./img/logo 69.svg" alt="Shreyansh-logo" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.instagram.com/shreyanshkumar05/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/shreyansh-kumar-49911b232/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Copyright c</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
